...
(function(a){
    a.fn.amazon_scroller=function(p){
		...
		dom.find(".amazon_scroller_title").height("150px");
        s_s_ul(dom,j,k,l,i);
        ...
        function begin(){
            ...
            v=dom.find("ul:first").height();
            //console.log(dom.find("ul:first"));
            ...
            */
            ...
            dom.children(".amazon_scroller_mask").width(200);
            dom.children(".amazon_scroller_mask").height(v);
            dom.find("ul:first").children("li").show();
            dom.css("position","relative");
            dom.find("ul:first").css("position","absolute");
            dom.children(".amazon_scroller_mask").width('235px');
            dom.children(".amazon_scroller_mask").height('100px');
            dom.find(".amazon_scroller_nav").css('top',"50px");
        ...
        function s_s_nav(a,d){
            ...
            a.children("li").html('<img src="/skin/latest/scroller/img/arrow_right.gif" width="11" height="20">');
            a.children("li:first-child").html('<img src="/skin/latest/scroller/img/arrow_left.gif" width="11" height="20">');
