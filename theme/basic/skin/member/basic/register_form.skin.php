...
<div class="mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap">
        <table>
        <caption>가입 분류 선택</caption>
        <tbody>
        <tr>
            <th scope="row"><label for="reg_mb_id">가입분류<strong class="sound_only"></strong></label></th>
            <td>
                <input type="radio" name="mb_level" value='2' <?php if($member[mb_level]==2 or !$member[mb_level])echo 'checked'; ?> id='mb_level_2'>
                <label for='mb_level_2'>일반 회원</label>
                <span style='margin-right:20px;'></span>
                <input type="radio" name="mb_level" value='3' <?php if($member[mb_level]==3                      )echo 'checked'; ?> id='mb_level_3'>
                <label for='mb_level_3'>기업 회원</label>
    ...
    <div class="tbl_frm01 tbl_wrap" id="corp_info" style='display:none;'>
        <table>
        <caption>기업정보 입력   ( 회원 가입 후 관리자 인증시 가입이 완료됩니다. )</caption>
        <tbody>
        <span>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="reg_mb_1" name="mb_1" value="<?php echo get_text($member['mb_1']) ?>" <?php echo $required ?> <?php echo $readonly; ?> class="frm_input <?php echo $required ?> <?php echo $readonly ?>" size="20">
            </td>
            <th scope="row"><label for="reg_mb_2">사업자등록번호<strong class="sound_only">필수</strong></label></th>
            <td>
                <input type="text" id="reg_mb_2" name="mb_2" value="<?php echo get_text($member['mb_2']) ?>" <?php echo $required ?> <?php echo $readonly; ?> class="frm_input <?php echo $required ?> <?php echo $readonly ?>" size="20">
            </td>
        </tr>
        <tr>
            <th scope="row"><label for="reg_mb_icon">사업자등록증</label></th>
            <td colspan="3">
                <span class="frm_info">
                    gif만  등록됩니다.
                </span>
                <input type="file" name="mb_icon" id="reg_mb_icon" class="frm_input" accept="image/gif">
                <?php if ($w == 'u' && file_exists($mb_icon_path)) {  ?>
                <img src="<?php echo $mb_icon_url ?>" alt="사업자등록증">
                <input type="checkbox" name="del_corp_icon" value="1" id="del_corp_icon">
                <label for="del_corp_icon">삭제</label>
                <?php }  ?>
            </td>
        </tr>
        </tbody>
    ...
    $(function() {
        ...
        if( $('#mb_level_3').attr('checked') == 'checked' ){
             $('#corp_info').css('display', '');
        }
    ...
    $('#mb_level_3').click(function(){
        $('#corp_info').css('display', '');
    });

    $('#mb_level_2').click(function(){
